        ...
        <div className="w-full xl:flex xl:gap-x-[33px] xl:justify-normal xl:items-start">
              ...
              <div key={index} className="w-full flex gap-x-6">
                <div className="w-[112px] h-[112px]">
                  <Image
                    ...
                    src={item.productImage || "/default-image.png"} // Fallback to a default image
                    alt="cartPlant"
                    width={112}
                    height={112}
                  />
          ...
          <div className="w-full xl:w-[784px] hidden sm:flex flex-col justify-center items-center">
            ...
            <div className="w-[784px] h-[475px] flex-col justify-start items-start gap-[37px] inline-flex">
              ...
              {products.map((item, index) => (
                <div key={index} className="justify-start items-center gap-12 inline-flex">
                  <div className="w-[108px] h-[105px] relative">
                    <Image
                      className="w-[105px] h-[105px] left-[3px] top-0 absolute rounded-lg"
                      src={item.productImage || "/default-image.png"} // Fallback to a default image
                      alt={item.productName || "Product Image"}
                    />
                    <div className="w-[105px] h-[105px] left-0 top-0 absolute rounded-[10px]" />
                  </div>
                  <div className="w-[150px] text-neutral-400 text-base font-normal font-['Urbanist']">{item.productName || "Unknown Product"}</div>
                  ...
                  <div className="text-black text-base font-normal font-['Urbanist']">Rs. {item.productQty * item.price}</div>
...
export async function getServerSideProps(context) {
  ...
  if (error || !Array.isArray(products)) {
    ...
    return {
      props: {
        products: [],
        error: error || 'Failed to fetch cart products.',
      },
    };
  }
