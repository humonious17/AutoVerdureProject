      ...
      <div className="mt-[80px] md:mt-[72px] max-w-screen md:max-w-[655px] xl:max-w-[778px] w-full flex flex-col justify-center items-center">
        ...
        <div className="mt-[7px] md:mt-8 text-sm md:text-xl font-normal leading-6 md:leading-8 md:-tracking-[0.5px] text-secondaryGrayscale">
          ...
          <p>
            ...
            <br />
            We allow you to create an account and log in to use the service
            ...
            with your third-party social media service&#39;s account, such
            as your name, your email address, your activities or your contact
            list associated with that account.
            <br />
            You may also have the option of sharing additional information with
            us through your third-party social media service&#39;s account.
            If you choose to provide such information and personal data, during
            registration or otherwise, you are giving the us permission to use,
          ...
          <p>
            <strong>
              A. We may use Personal/Sensitive Personal Data for the following
              purposes:
            </strong>
            <br />
            <ul>
              ...
              <li>
                ...
                some or all of Our assets, whether as a going concern or as part
          ...
          <p>
            <br />
            <strong>
              B. We may share your personal information in the following
              situations:
            </strong>
            <br />
            <ul>
              <li>
                ...
                with service providers to monitor and analyze the use of
              ...
              <li>
                ...
                to honour this privacy policy. Affiliates include our parent
              ...
              <li>
                ...
                name, profile, pictures and description of your
                activity. similarly, other users will be able to view
                descriptions of your activity, communicate with you and
                view your profile.
              </li>
              <li>
          ...
          <p>
            ...
            at our operating offices and in any other places where the parties
            ...
            such information represents your agreement to that transfer. We will
          ...
          <p>
            ...
            <ul>
              <li>
                • Business Transactions: If we are involved in a merger,
              ...
              <li>
                ...
                <li>
                  d) Protect the personal safety of users of the service or the
                  public
                </li>
