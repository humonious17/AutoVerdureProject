...
const Community = () => {
  return (
    <div className="w-full px-4 mt-[75px] pt-[44px] pb-[104px] md:px-[86px] md:py-[116px] xl:px-[119.99px] xl:pt-[114px] xl:pb-[151px] 2xl:px-[200px] 2xl:py-[116px] bg-[#FFFBF7] flex flex-col justify-center items-center overflow-hidden">
      {/* Title */}
