  ...
  return (
    <div
      className={`max-w-[373px] h-[315px] md:w-full md:h-[308.96px] xl:w-[373px] xl:h-[315px] px-8 pt-[52px] pb-[75px] rounded-3xl ease-in-out duration-200 
        ${isActive ? "bg-primaryMain text-white" : isMobile ? backgroundColor : "bg-primaryCream"}`} // Apply the color logic
    >
      <Image
        className={`object-contain md:w-[39.233px] md:h-[39.22px] ${isActive ? "text-[#BABABA]" : ""}`}
      ...
      <div className="mt-[39px] max-w-[309px] md:w-[303.075px] xl:w-[309px]">
        <p
          className={`text-2xl md:text-[23.54px] xl:text-2xl leading-[28.8px] md:leading-[28.248px] xl:leading-[28.8px] -tracking-[0.6px] md:-tracking-[0.588px] xl:-tracking-[0.6px] font-[600] ease-in-out duration-200 ${isActive ? "text-white" : "text-primaryGrayscale"}`}
        >
          {data.title}
        </p>
        <p
          className={`mt-2 text-sm md:text-[13.732px] xl:text-sm leading-6 md:leading-[23.54px] xl:leading-6 font-normal ease-in-out duration-200 ${isActive ? "text-white" : "text-#6F6E73"}`}
          style={{
            textAlign: "left",
            fontFamily: "Urbanist",
            fontSize: "16px",
            ...
            fontWeight: 425,
            lineHeight: "24px",
            color: isActive ? "white" : "color(display-p3 0.2375 0.2375 0.2375)",
          }}
        >
          {data.description}
        </p>
