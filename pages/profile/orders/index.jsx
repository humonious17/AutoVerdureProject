...
const OrderDetailDialog = ({ order, open, onClose }) => {
  ...
  return (
    <Dialog open={open}>
      <DialogContent className="sm:max-w-3xl h-[90vh] sm:h-auto overflow-y-auto bg-[#fffbf7]">
        <DialogHeader>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-600">Location: {shippingCity}</p>
              ...
              <div className="bg-orange-50 text-orange-700 px-3 py-1 rounded-full inline-block text-sm">
                Arriving in 2 days
              </div>
              <button className="text-purple-600 flex items-center gap-2 mt-2 text-sm">
          ...
          <form onSubmit={handleSubmitReview} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <textarea
                className="w-full p-3 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                rows="4"
            ...
            <button
              type="submit"
              className="w-full py-3 bg-purple-600 text-white text-sm font-bold rounded-full hover:bg-purple-700 transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={isSubmitting}
            >
