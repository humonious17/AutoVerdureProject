      ...
      <div className="mt-[7px] md:mt-8 text-sm md:text-xl font-normal leading-6 md:leading-8 md:-tracking-[0.5px] text-secondaryGrayscale">
        ...
        <div className="w-full px-3">
          <div className="w-full flex gap-2">
            <p>1.</p>
            <p>
              This website is operated by XirdE Private Limited. Throughout the
              site, the terms “we”, “us” and “our” refer to Auto Verdure. Auto
              Verdure offers this website, including all information, tools and
        ...
        <div className="w-full px-3">
          ...
          <div className="w-full flex gap-2">
            <p>5.</p>
            <p>
              In no case shall Auto Verdure, our directors, officers, employees,
        ...
        <div className="w-full px-3">
          <div className="w-full flex gap-2">
            <p>1.</p>
            <p>
              You agree to indemnify, defend and hold harmless Auto Verdure and
