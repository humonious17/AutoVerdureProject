...
const Plants = (props) => {
  const plants = props.products;
  const [filteredProducts, setFilteredProducts] = useState(plants); // Initialize with zenpot
  ...
  const handleFilterChange = (filters) => {
    let filtered = [...plants]; // Use zenpot for initial filtering
