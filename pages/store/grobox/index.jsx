...
const Grobox = (props) => {
  ...
  const [filteredProducts, setFilteredProducts] = useState(grobox);
  ...
  useEffect(() => {
    console.log("Fetched Grobox Products:", grobox);
  }, [grobox]);

  // Update displayedProductsCount whenever filteredProducts or showCount changes
  useEffect(() => {
  ...
  const handleSort = (sortType) => {
    ...
    // Debugging: Log the sorted products
  ...
  // Debugging: Log valid products for display
  useEffect(() => {
