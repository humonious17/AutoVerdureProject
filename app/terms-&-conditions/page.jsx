        ...
        <div className="mt-[7px] md:mt-8 text-sm md:text-xl font-normal leading-6 md:leading-8 md:-tracking-[0.5px] text-secondaryGrayscale">
          ...
          <div className="w-full px-3">
            <div className="w-full flex gap-2">
              <p>1.</p>
              <p>
                This website is operated by XirdE Private Limited. Throughout the site, the terms “we”, “us” and “our” refer to Auto Verdure. Auto Verdure offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
              </p>
            </div>
            <div className="w-full flex gap-2">
              <p>2.</p>
          ...
          <strong>B. Online Store Terms:</strong>
          <br />
          <div className="w-full px-3">
            <div className="w-full flex gap-2">
              <p>1.</p>
          ...
          <strong>C. General Conditions:</strong>
          <br />
          <div className="w-full px-3">
            <div className="w-full flex gap-2">
              <p>1.</p>
          ...
          <strong>D. Accuracy, Completeness and Timeliness of Information:</strong>
          <br />
          <div className="w-full px-3">
            <div className="w-full flex gap-2">
              <p>1.</p>
          ...
          <strong>E. Modifications to the Service and Prices:</strong>
          <br />
          <div className="w-full px-3">
            <div className="w-full flex gap-2">
              <p>1.</p>
          ...
          <strong>F. Products or Services (if applicable):</strong>
          <br />
          <div className="w-full px-3">
            <div className="w-full flex gap-2">
              <p>1.</p>
          ...
          <strong>G. Accuracy of Billing and Account Information:</strong>
          <br />
          <div className="w-full px-3">
            <div className="w-full flex gap-2">
              <p>1.</p>
          ...
          <strong>H. Optional Tools:</strong>
          <br />
          <div className="w-full px-3">
            <div className="w-full flex gap-2">
              <p>1.</p>
          ...
          <strong>I. Third-Party Links:</strong>
          <br />
          <div className="w-full px-3">
            <div className="w-full flex gap-2">
              <p>1.</p>
          ...
          <strong>J. User Comments, Feedback and Other Submissions:</strong>
          <br />
          <div className="w-full px-3">
            <div className="w-full flex gap-2">
              <p>1.</p>
          ...
          <strong>K. Personal Information:</strong>
          <br />
          <div className="w-full px-3">
            <div className="w-full flex gap-2">
              <p>1.</p>
          ...
          <strong>L. Errors, Inaccuracies and Omissions:</strong>
          <br />
          <div className="w-full px-3">
            <div className="w-full flex gap-2">
              <p>2.</p>
          ...
          <strong>M. Prohibited Uses:</strong>
          <br />
          <div className="w-full px-3">
            <div className="w-full flex gap-2">
              <p>1.</p>
          ...
          <strong>N. Disclaimer of Warranties; Limitation of Liability:</strong>
          <br />
          <div className="w-full px-3">
            <div className="w-full flex gap-2">
              <p>1.</p>
            ...
            <div className="w-full flex gap-2">
              <p>5.</p>
              <p>
                In no case shall Auto Verdure, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.
              </p>
            </div>
          </div>

          <strong>O. Indemnification:</strong>
          <br />
          <div className="w-full px-3">
            <div className="w-full flex gap-2">
              <p>1.</p>
              <p>
                You agree to indemnify, defend and hold harmless Auto Verdure and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
              </p>
            </div>
          </div>

          <strong>P. Severability:</strong>
          <br />
          <div className="w-full px-3">
            <div className="w-full flex gap-2">
              <p>1.</p>
          ...
          <strong>R. Entire Agreement:</strong>
          <br />
          <div className="w-full px-3">
            <div className="w-full flex gap-2">
              <p>1.</p>
          ...
          <strong>T. Changes to Terms of Service:</strong>
          <br />
          <div className="w-full px-3">
            <div className="w-full flex gap-2">
              <p>1.</p>
          ...
          <strong>U. Contact Information:</strong>
          <br />
          <div className="w-full px-3">
            <div className="w-full flex gap-2">
              ...
              <p>
                ...
                Tel: +91-9289671707
                <br/>
                Address: XirdE, 4 F., 1797, Sector 52, Gurugram, Haryana, 122001.
              </p>
            {/* <div classname="w-full flex gap-2"> */}
